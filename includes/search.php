...
<html>
	...
	<body style="background-color: white;">
		...
		<?php
			...
			$keyword = mysqli_real_escape_string($conn,$_POST['sear']);
			if($keyword == ""){
				echo '<script type="text/javascript">alert("Please enter some keywords to search !\n Try again");location="../home/index.php?search=empty";</script>';
			}

			else
			{
			
				$sql = "select * from products where title like '%$keyword%' or category like '%$keyword%' or subcat like '%$keyword%' or brand like '%$keyword%';";
