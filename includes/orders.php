<?php
					...
					$bid = $_SESSION['b_id'];
					$sql = "select * from products inner join orders on products.p_id=orders.p_id  where b_id = '$bid'";
								...
								<div class="col-md-9">
									...
									while ($rows = mysqli_fetch_assoc($result)){
										echo '<div class="col-md-3" style="margin-top: 5%">
											...
											<button type="submit" class="btn btn-danger" name="can_btn">Cancel</button>
											</form>
										</div>';
									}
									echo '</div>
